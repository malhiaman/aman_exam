 ...
 */
function amstarter_custom_colors_css() {
	 ...
	 */
	$saturation = absint( apply_filters( 'amstarter_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.amstarter-front-page) .entry-title,
...
.colors-custom .amstarter-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.amstarter-front-page .panel-content .recent-posts article,
...
.colors-custom.amstarter-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	 ...
	 */
	return apply_filters( 'amstarter_custom_colors_css', $css, $hue, $saturation );
}
