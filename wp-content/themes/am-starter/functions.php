...
if ( ! function_exists( 'am_starter_setup' ) ) :
	...
	function am_starter_setup() {
		...
		add_theme_support( 'custom-background', apply_filters( 'am_starter_custom_background_args', array(
...
add_action( 'after_setup_theme', 'am_starter_setup' );
 ...
 */
function am_starter_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'am_starter_content_width', 640 );
}
add_action( 'after_setup_theme', 'am_starter_content_width', 0 );
...
add_action( 'widgets_init', 'am_starter_widgets_init' );
...
add_action( 'wp_enqueue_scripts', 'am_starter_scripts' );
